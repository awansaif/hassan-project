                ...
                <div class="page-body">
                    ...
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="w-75 m-auto">
                            ...
                            <input type="text" name="team_one_name" id="team_one_name" value="{{ $team->team_one_name }}" class="form-control">
                            ...
                            <input type="text" name="team_two_name" id="team_two_name" value="{{ $team->team_two_name }}" class="form-control">

                            <br>
                            <button class="btn btn-success float-right">Update Team</button>
                        </div>
                    </form>
                </div>
            </div>
