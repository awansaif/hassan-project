                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="description"
                                                    class="form-control">{{ $data->sponsor_description }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Sponsor Image<span
                                                    style="color:#ff0000"> *</span></label>
                                            <div class="col-sm-10">
                                                <img src="{{ $data->sponser_image }}" alt="" width="200px" height="200px">
                                                <br>
                                                <br>
                                        ...
                                        <button type="submit" class="btn btn-primary float-right"
                                            ...
                                            title="Primary color states" data-placement="bottom">Update Sponsor</button>
