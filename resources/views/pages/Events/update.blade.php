            ...
            <div class="page-wrapper">
                ...
                <div class="page-body pb-4">
                    ...
                    <h4 class="sub-title ">
                        ...
                        <span class="text-center">Update Event</span>
                    </h4>
                    ...
                    <form method="post" action="{{ Route('event.update', $event->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                ...
                                <input type="text" class="form-control" name="zip_code" value="{{ $event->zip_code }}"
                            ...
                            <div class="col-sm-4">
                                <div style="width:100%; height: 250px; margin-bottom: 10px;">
                                    ...
                                    <img id="event-image-dsp" src="{{ $event->event_image }}" alt="" width="100%"
                                        height="90%">
                                </div>
                                <div style="width:100%; height: 250px; margin-bottom: 10px;">
                                    <h5 class="text-center">Event Secondary Image</h5>
                                    <img id="secondary-image-dsp" src="{{ $event->secondary_image }}" alt=""
                                        width="100%" height="90%">
                                </div>
                                <div style="width:100%; height: 250px; margin-bottom: 10px;">
                                    <h5 class="text-center">Author Image</h5>
                                    <img id="author-image-dsp" src="{{ $event->author_image }}" alt="" width="100%"
                                        height="100%">
                                </div>
                            </div>
                        </div>
