				...
				<div class="page-body">
					<div class="card">
						<div class="card-header">
							<h2 class="text-primary">Federation Event List</h2>
						</div>
						<div class="card-body">
								...
								<table class="table table-striped table-bordered" id="dataTable">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<a href="/edit-federation-event?id={{ $event->id }}" class="btn btn-primary">Edit</a>
												<a href="/remove-federation-event?id={{$event->id}}" class="btn btn-danger"> Remove</a>
											</td>
										</tr>
										@endforeach
									</tbody>
