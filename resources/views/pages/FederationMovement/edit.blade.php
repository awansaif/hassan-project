            ...
            <div class="page-wrapper">
                ...
                <div class="page-body">
                    ...
                    <div class="mb-2">
                        ...
                        <h2 class="text-secondary text-capitalize text-center">UPDATE FEDERATION MOVEMENT</h2>
                    </div>
                    <hr>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            @endif
                            <form method="post" action="{{ Route('federationmovement.update', $federation->id) }}"
                                ...
                                <select name="club" id="club" class="form-control custom-select">
                                    ...
                                    <optgroup label="{{ $club->club_name }}">
                                        ...
                                        <option value="{{ $club->id }}"
                                            {{ $federation->club_id == $club->id ? 'selected' : '' }}>{{ $club->name  }}
                                        </option>
                                        @endforeach
                                    </optgroup>
                                    @endforeach
                                ...
                                <input type="datetime-local" class="form-control" name="latest_event"
                                    value="{{ $federation->latest_event }}">


                                <button type="submit" class="btn btn-success float-right mt-5">Update
                                    Federation</button>
                            </form>
                        ...
                        <div class="col-sm-6">
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <img src="{{ $federation->icon }}" alt="" width="100%" height="200px"
                                        id="iconPreview">
                                </div>
                                <div class="col-sm-6">
                                    <h2 class="text-secondary text-center text-capitalize">IMAGE</h2>
                                    <img src="{{ $federation->image }}" alt="" width="100%" height="200px"
                                        id="imagePreview">
                                </div>
                            </div>
                        </div>
