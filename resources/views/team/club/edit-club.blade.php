        ...
        <div class="container">
            <div class="p-4">
                ...
                <form method="post" class="w-75 m-auto" enctype="multipart/form-data">
                    <a href="{{ url('team/show-club', Request::route('id')) }}"
                    ...
                    <input type="text" name="name" id="name" value="{{ $club->name }}" class="form-control"
                    ...
                    <input type="text" name="country" id="country" value="{{ $club->country }}" class="form-control"
